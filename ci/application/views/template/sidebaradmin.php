  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #C8C8C8;">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
    <a href="<?= base_url('dashboardadmin')?>" class="nav-link ">
    <lord-icon
    ...
    style="width:30px;height:30px">
        ...
        <p style="color: black;">DASHBOARD</p>
                ...
                <li class="nav-item">
    <a href="<?= base_url('Stokbarangadmin')?>" class="nav-link ">
    <lord-icon
...
<li class="nav-item">
    <a href="<?= base_url('pengeluaranadmin')?>" class="nav-link ">
    <lord-icon
...
<li class="nav-item">
    <a href="<?= base_url('Penjualanadmin')?>" class="nav-link ">
    <lord-icon
